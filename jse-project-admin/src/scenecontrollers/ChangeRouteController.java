...
public class ChangeRouteController {
    ...
    public Route initData(Route route) {
        this.tempRoute = route;
        numberRoute.setText(tempRoute.getNumber());
        nameRoute.setText(tempRoute.getName());
        listStations.addAll(tempRoute.getStops());
    ...
    @FXML
    void confirmChangeNumber(ActionEvent event) {
    ...
    @FXML
    void calculateIndexAddStation(MouseEvent event) {
        if (listIndex.size() > 0) {
            listIndex.clear();
        }
    ...
    @FXML
    void confirmAddStation(ActionEvent event) {
    ...
    @FXML
    void confirmChangeStation(ActionEvent event) {
        boolean checkName = true;
        boolean checkDepartureTime = true;
        boolean checkArrivalTime = true;
    ...
    @FXML
    void cancelChangeStation(ActionEvent event) {
        setVoidFieldsValues();
        buttonConfirmAddStation.setDisable(false);
    }
